...
import { domianManagerAction } from "redux/domain-manager/domain-manager.slice";
import ListDomainsTable from "./components/ListDomainsTable";
...
function DomainManager() {
    ...
    const handleSearch = () => {
        dispatch(
            domianManagerAction.getListDomains({
                pageIndex: pageIndex,
                pageSize: pageSize,
                search,
    ...
    //    await dispatch(domianManagerAction.updateMany(obj));
       handleSearch()
    }
            ...
            <div className="mb-4">
                <Breadcrumb
                    items={[
                        ...
                        { title: "Xác thực tên miền" },
                    ]}
                ></Breadcrumb>
            </div>
            <div className="mb-4">
                <h3 className="font-semibold mb-4">Xác thực tên miền</h3>
