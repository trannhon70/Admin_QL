...
const ComponentMakeProgressCommentTwitter = () => {
      ...
      <div className='basis-2/6 pl-5 '>
        <div className='bg-orange-300 rounded-lg p-4'>
          ...
          <div className='text-base text-slate-900 font-normal mt-4'>
            - Hệ thống sử dụng 99% tài khoản người VN, twitter thật để tương tác
            like, sub, comment....
          </div>
          <div className='text-base text-slate-900 font-normal mt-4'>
...
export default ComponentMakeProgressCommentTwitter;
