...
const ComponentMakeProgressTwitter = () => {
  ...
  const handleOnBlur = () => {
    if (Number(form.price) < 2) {
      ...
      api.warning({
        message: 'Số tiền mỗi lần tương tác phải ít nhất là 2 credits',
      });
    }
  };
  return (
      ...
      <div className='basis-4/6'>
        <div className='flex '>
          ...
          <div className='w-3/4'>
            <Input
              className='h-[40px]'
              placeholder='Ví dụ: https://twitter.com/MyAccountName'
              onChange={(e) => {
        ...
        <div className='mt-5 bg-yellow-500 rounded-lg p-4 text-center'>
          ...
          <div className='text-base font-normal text-white'>
            ...
            <span className='font-bold'> {form.price} </span>credit/subcribe
          </div>
        </div>
        <button
...
export default ComponentMakeProgressTwitter;
