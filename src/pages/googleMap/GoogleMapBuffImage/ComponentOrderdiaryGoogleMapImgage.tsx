...
const columns: ColumnsType<any> = [
  ...
  },
  {
    ...
    key: "link",
    render: (value) => {
      return <Popover content={value}>{value.substring(0, 40)}...</Popover>;
    },
  },
  {
    title: "Hình ảnh",
...

  {
    ...
    sorter: (a, b) => a.createdAt.localeCompare(b.price),
  },
];

const ComponentOrderdiaryGoogleMapImgage = () => {
...
export default ComponentOrderdiaryGoogleMapImgage;
