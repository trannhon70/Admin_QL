...
import { createTask, createTrafficGoogle } from "api/task.api";
...
const ComponentMakeProgressSearchAndRateAppImage = () => {
  ...
  const onclickMakeProgress = async () => {
    ...
    if (form.keyWord === "")
      return message.warning("Nội dung tìm kiếm map không được bỏ trống!");
    if (form.comment === "")
      return message.warning("Nội dung đánh tìm kiếm map không được bỏ trống!");
    ...
    <div className="flex flex-row mt-2">
      ...
      <div className="basis-4/6">
        ...
        <div className="flex mt-5 ">
          <div className="text-cyan-700 font-bold text-base w-1/4">
            Nhập nội dung tìm kiếm map:
          </div>
          <div className="w-3/4">
            <Input
              className="h-[40px]"
              placeholder="Nội dung tìm kiếm map"
              onChange={(e) => {
        ...
        <div className="mt-3 flex">
          <div className="text-lg text-cyan-700 font-bold w-1/4">
            Thêm hình ảnh mô tả
          </div>
...
export default ComponentMakeProgressSearchAndRateAppImage;
