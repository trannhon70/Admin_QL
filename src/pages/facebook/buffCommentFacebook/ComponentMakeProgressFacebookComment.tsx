...
const ComponentMakeProgressFacebookComment = () => {
  ...
  const handleOnBlur = () => {
    if (Number(form.price) < 5000) {
      setForm({ ...form, price: 5000 });
      api.warning({
        message: 'Số tiền mỗi lần tương tác phải ít nhất là 5.000 VNĐ',
      });
    }
  };
        ...
        <div className='flex mt-5'>
          <div className='text-cyan-700 font-bold text-base w-1/4'>
            ...
            <div className='text-red-400 font-bold text-base mt-1'>
              Giá thấp nhất: {form.price} credit
            </div>
          </div>
          <div className='w-3/4'>
            <Input
...
export default ComponentMakeProgressFacebookComment;
