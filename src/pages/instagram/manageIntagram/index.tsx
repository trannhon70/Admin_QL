...
import {
  checkChannelFollowedDoneInstagram,
...
const ManageInstagram = () => {
  ...
  const handleCheck = async (e: any) => {
    ...
    const result: any = await checkChannelFollowedDoneInstagram(body);
  ...
  return (
    <div className="p-4" id="manage">
      <div className="mb-4">
        <Breadcrumb
          items={[
            { title: "Quản lý nhiệm vụ instagram" },
            { title: "Nhiệm vụ instagram" },
          ]}
        ></Breadcrumb>
      </div>
      <div className="mb-4">
