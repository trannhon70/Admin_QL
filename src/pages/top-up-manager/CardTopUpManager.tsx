...
function CardTopUpManager() {
   ...
   useEffect(() => {
      dispatch(topUpAction.getListCardTopUp({ page: pageIndex, limit: pageSize }));
   }, [pageIndex, pageSize]);

   return (
      <div className="p-4">
         <div className="mb-4">
            <Breadcrumb items={[{ title: "Quản lý nạp tiền" }, { title: "Nạp thẻ" }]}></Breadcrumb>
         </div>
         <div className="mb-4">
            <h3 className="font-semibold mb-4">Danh sách nạp qua thẻ</h3>
