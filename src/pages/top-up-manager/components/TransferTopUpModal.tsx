...
const TransferTopUpModal = (props: PropsType) => {
   ...
   return (
      <>
         ...
         <Modal
            title={<h5>Nạp tiền cho người dùng</h5>}
            open={isModalOpen}
            onOk={handleOk}
               ...
               <div className="mb-4">
                  ...
                  <input
                     ...
                     onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                        ...
                        formik.setFieldValue("bodyTransfer", `naptien ${e.target.value}`);
                     }}
...
export default TransferTopUpModal;
